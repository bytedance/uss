...
CUDA_VISIBLE_DEVICES=3 python3 pytorch/ss_main.py inference_new_stereo --workspace=$WORKSPACE --at_checkpoint_path=$AT_CHECKPOINT_PATH --data_type='balanced_train' --model_type='UNet' --loss_type='mae' --balanced='balanced' --augmentation='none' --batch_size=2 --iteration=100000 --cuda
