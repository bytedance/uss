...
CUDA_VISIBLE_DEVICES=0 python3 pytorch/ss_main.py inference_new --workspace=$WORKSPACE --at_checkpoint_path=$AT_CHECKPOINT_PATH --data_type='balanced_train' --model_type='UNet_16k' --loss_type='mae' --balanced='balanced' --augmentation='none' --batch_size=2 --iteration=100000 --cuda
