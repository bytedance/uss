...
WORKSPACE="/home/tiger/workspaces/uss"
...
./scripts/2_create_indexes.sh /home/tiger/workspaces/uss/
...
# python3 uss/dataset_creation/create_indexes.py combine_full_indexes \
...
CUDA_VISIBLE_DEVICES=0 python3 uss/evaluate.py

python3 uss/plot.py


CUDA_VISIBLE_DEVICES=3 python3 uss/inference.py \
